...
local opts = require("kwconfig").kawaiidash
...
M.open = function(buf, win, action)
  ...
  require("kawaii.utils").set_cleanbuf_opts("kawaiidash", buf)
  ...
  api.nvim_create_autocmd({ "WinResized", "VimResized" }, {
    ...
    callback = function()
      ...
      require("kawaii.kawaiidash").open(vim.g.kawaiidash_buf, vim.g.kawaiidash_win, "redraw")
    end,
  })
end
