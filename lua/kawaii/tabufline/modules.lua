...
local txt = require("kawaii.tabufline.utils").txt
local btn = require("kawaii.tabufline.utils").btn
...
vim.cmd [[
  function! TbGoToBuf(bufnr,b,c,d)
    call luaeval('require("kawaii.tabufline").goto_buf(_A)', a:bufnr)
  endfunction]]

vim.cmd [[
  function! TbKillBuf(bufnr,b,c,d) 
    call luaeval('require("kawaii.tabufline").close_buffer(_A)', a:bufnr)
  endfunction]]

vim.cmd "function! TbNewTab(a,b,c,d) \n tabnew \n endfunction"
vim.cmd "function! TbGotoTab(tabnr,b,c,d) \n execute a:tabnr ..'tabnext' \n endfunction"
vim.cmd "function! TbCloseAllBufs(a,b,c,d) \n lua require('kawaii.tabufline').closeAllBufs() \n endfunction"
