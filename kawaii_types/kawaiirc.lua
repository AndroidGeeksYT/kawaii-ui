...
---@class KawaiiRCConfig
---@field ui? UIConfig
---@field base46? Base46Config
---@field lsp? KwLspConfig
---@field term? TermConfig
---@field cheatsheet? KwCheatsheetConfig
...
---     }
--- ```
--- see https://github.com/AndroidGeeksYT/base46/tree/kawaii/lua/base46/integrations
...
--- see https://github.com/AndroidGeeksYT/base46/tree/kawaii/lua/base46/themes for the colors of each theme
...
--- see https://github.com/AndroidGeeksYT/base46/tree/kawaii/lua/base46/themes
...
---@class UIConfig
---@field cmp? KwCmpConfig
---@field telescope? KwTelescopeConfig
---@field statusline? KwStatusLineConfig
---@field tabufline? KwTabLineConfig
--- Whether to enable LSP Semantic Tokens highlighting
--- List of extras themes for other plugins not in Kawaii that you want to compile
...
--- @field format_colors? KwCmpFormatColors

---@class KwTelescopeConfig
--- Telescope style
---@field style? '"borderless"'|'"bordered"'

---@class KwStatusLineConfig
---@field enabled? boolean
--- statusline theme
---@field theme? '"default"'|'"vscode"'|'"vscode_colored"'|'"minimal"'
--- Separator style for Kawaii Statusline
...
--- Check https://github.com/AndroidGeeksYT/kawaii-ui/blob/kawaii/lua/kawaii/stl/utils.lua#L12 for the modules of each statusline theme
---@field order? string[]
...
--- Options for Kawaii Tabufline
---@class KwTabLineConfig
...
---@class KwCheatsheetConfig
--- Cheatsheet theme
---@field theme? '"grid"'|'"simple"'
---@field excluded_groups? string[]

---Options for AndroidGeeksYT/kawaii-ui lsp configuration
---@class KwLspConfig
